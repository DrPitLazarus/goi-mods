...
/// <summary>
/// Uploads current world map data for all territories. Currently used to get 5 recent battle logs for each faction.
/// </summary>
public class WorldMapDataTask : MonoBehaviour
{
    ...
    private IEnumerator MainTask()
    {
        ...
        {
            _requestDone = true;
            _payloadJson["data"] = resp.JsonData;
        });
    ...
    {
        using var request = UnityWebRequest.Put(DataKit.GetApiUrl("world-map-data"), data);
        request.method = "POST";
